class Exod_BlueStahli_XMV850Attachment extends UM_BaseMachineGunAttachment;
...
defaultproperties
{
	 FireModeEffects[0]=(MuzzleBones=("tip"),FlashClasses=(Class'ROEffects.MuzzleFlash3rdMP'),SmokeClasses=(Class'UnlimaginMod.UM_BaseMuzzleSmoke3rd'),ShellEjectBones=("ejector"),ShellEjectClasses=(Class'KFMod.KFShellSpewer'))
