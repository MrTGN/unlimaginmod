class Maria_M37IthacaPickup extends UM_BaseShotgunPickup;
...
defaultproperties
{
     ...
     ItemShortName="Ithaca Shotgun"
     AmmoItemName="12-Gauge shells"
     CorrespondingPerkIndex=1
     EquipmentCategoryID=2
     InventoryType=Class'UnlimaginMod.Maria_M37IthacaShotgun'
     PickupMessage="You got the M37 Ithaca Shotgun."
     PickupSound=Sound'KF_ShotgunDragonsBreathSnd.Handling.TrenchGun_Pump_Back'
     PickupForce="AssaultRiflePickup"
     StaticMesh=StaticMesh'FMX_Ithaca_SM.Rifles.Ithaca_Pickup'
