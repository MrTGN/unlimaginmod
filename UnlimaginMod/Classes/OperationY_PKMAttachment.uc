class OperationY_PKMAttachment extends UM_BaseMachineGunAttachment;


defaultproperties
{
	 FireModeEffects[0]=(MuzzleBones=("wpn_silencer"),FlashClasses=(Class'UnlimaginMod.MuzzleFlash3rdPKM'),SmokeClasses=(Class'UnlimaginMod.UM_BaseMuzzleSmoke3rd'),ShellEjectBones=("magazin"),ShellEjectClasses=(Class'UnlimaginMod.OperationY_PKMShellSpewer'))
