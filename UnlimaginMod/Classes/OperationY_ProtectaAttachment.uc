class OperationY_ProtectaAttachment extends UM_BaseShotgunAttachment;

defaultproperties
{
	 FireModeEffects[0]=(ShellEjectBones=("baraban"),ShellEjectClasses=(Class'KFMod.KFShotgunShellSpewer'))
	 ...
	 MeshRef="Protecta_A.protecta_3rd"
     DrawScale=0.600000
}
