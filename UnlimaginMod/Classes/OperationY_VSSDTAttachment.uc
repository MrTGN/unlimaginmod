class OperationY_VSSDTAttachment extends UM_BaseAutomaticSniperRifleAttachment;


defaultproperties
{
	 FireModeEffects[0]=(MuzzleBones=("tip"),FlashClasses=(Class'UnlimaginMod.OperationY_MuzzleFlash3rdVSSDT'),SmokeClasses=(Class'UnlimaginMod.UM_BaseMuzzleSmoke3rd'),ShellEjectBones=("Shell_eject"),ShellEjectClasses=(Class'KFMod.KFShellSpewer'))
	 ...
	 MeshRef="VSSDT_v2_A.vintorezDT3rd"
	 DrawScale=0.550000
}
