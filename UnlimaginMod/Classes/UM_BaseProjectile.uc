...
simulated event PreBeginPlay()
{
	...
	if ( UM_BaseWeapon(Owner) != None )  {
		...
		//[!] Todo: ïîäóìàòü ãäå è êàê õðàíèòü íàñòðîéêè è äàííûå ñòâîëîâ, îðóæèÿ è òï.
		// Äóìàþ, ÷òî ýòî ìîæåò áûòü ôóíêöèÿ, âîçâðàùàþùàÿ äàííûå ïî ïîñëåäíåìó âûñòðåëó.
		// Ñàìè íàñòðîéêè õðàíèòü â Fire êëàññå, à èç îðóæèÿ ïîëó÷àòü ÷åðåç ôóíêöèþ íóæíûå
		// õàðàêòåðèñòèêè ïî ïîñëåäíåìó âûñòðåëó.
