...
simulated function PlayIdle()
{
	if ( Instigator.IsLocallyControlled() )  {
		//Todo: âîçìîæíî bActuallyFinishReloading ìîæíî óáðàòü, èáî ÿ òåïåðü îáíîâëÿþ
		// íà êëèåíòå êîëè÷åñòâî ïòàðîíîâ îáîéìå ïðÿìî â ôóíêöèè ClientForceKFAmmoUpdate
