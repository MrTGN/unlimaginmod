...
defaultproperties
{
	 ...
	 GameWaves(1)=(AliveMonsters=(Min=18,Max=48),MonsterSquadSize=(Min=4,Max=6),SquadsSpawnPeriod=(Min=2.5,Max=4.5),WaveDifficulty=0.8,WaveStartDelay=10,WaveDuration=(Min=8.0,Max=10.0),BreakTime=(Min=90,Max=110),DoorsRepairChance=0.55,StartingCash=(Min=260,Max=300),MinRespawnCash=(Min=220,Max=240),DeathCashModifier=0.89)
	 GameWaves(2)=(AliveMonsters=(Min=20,Max=48),MonsterSquadSize=(Min=4,Max=8),SquadsSpawnPeriod=(Min=2.5,Max=5.0),WaveDifficulty=0.9,WaveStartDelay=8,WaveDuration=(Min=9.0,Max=11.0),BreakTime=(Min=100,Max=110),DoorsRepairChance=0.5,StartingCash=(Min=280,Max=320),MinRespawnCash=(Min=240,Max=260),DeathCashModifier=0.88)
	 ...
	 GameWaves(4)=(AliveMonsters=(Min=24,Max=50),MonsterSquadSize=(Min=6,Max=10),SquadsSpawnPeriod=(Min=4.0,Max=6.0),WaveDifficulty=1.1,WaveStartDelay=6,WaveDuration=(Min=11.0,Max=13.0),BreakTime=(Min=110,Max=120),DoorsRepairChance=0.4,StartingCash=(Min=320,Max=360),MinRespawnCash=(Min=280,Max=300),DeathCashModifier=0.86)
	 GameWaves(5)=(AliveMonsters=(Min=26,Max=52),MonsterSquadSize=(Min=6,Max=10),SquadsSpawnPeriod=(Min=4.0,Max=6.5),WaveDifficulty=1.2,WaveStartDelay=6,WaveDuration=(Min=12.0,Max=14.0),BreakTime=(Min=110,Max=130),DoorsRepairChance=0.35,StartingCash=(Min=340,Max=380),MinRespawnCash=(Min=300,Max=320),DeathCashModifier=0.85)
	 GameWaves(6)=(AliveMonsters=(Min=26,Max=52),MonsterSquadSize=(Min=6,Max=10),SquadsSpawnPeriod=(Min=4.0,Max=7.0),WaveDifficulty=1.3,WaveStartDelay=5,WaveDuration=(Min=13.0,Max=15.0),BreakTime=(Min=120,Max=130),DoorsRepairChance=0.3,StartingCash=(Min=360,Max=400),MinRespawnCash=(Min=320,Max=340),DeathCashModifier=0.84)
	 // Boss
