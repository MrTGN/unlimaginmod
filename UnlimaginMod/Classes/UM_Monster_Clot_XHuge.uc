...
----------------------------------------------------------------------------------
	Comment:		 
==================================================================================*/
class UM_Monster_Clot_XHuge extends UM_Monster_Clot_Standard;
...
defaultproperties
{
	 ...
	 CollisionRadius=24.75
	 BaseEyeHeight=60.5
	 EyeHeight=60.5
	 CrouchHeight=44.088
	 CrouchRadius=24.75
	 OnlineHeadshotOffset=(X=1.5125,Y=0.0,Z=58.575)
	 OnlineHeadshotScale=1.625
	 // Mass
	 Mass=250.0
}
