...
//––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––
//	Creation date:	 19.07.2013 16:07
//––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––
//	Comments:		 
//================================================================================
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'UnlimaginMod.UM_SmallExpBulletExplosionEffect.WhiteSmoke1'
     ...
     End Object
     Emitters(1)=SpriteEmitter'UnlimaginMod.UM_SmallExpBulletExplosionEffect.RadialExplosion1'
     ...
     End Object
     Emitters(2)=SpriteEmitter'UnlimaginMod.UM_SmallExpBulletExplosionEffect.ExplosionsImpact1'
