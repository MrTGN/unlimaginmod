class Whisky_ColtM1911Attachment extends UM_BaseHandgunAttachment;

defaultproperties
{
	 FireModeEffects[0]=(MuzzleBones=("tip"),FlashClasses=(Class'ROEffects.MuzzleFlash3rdMP'),SmokeClasses=(Class'UnlimaginMod.UM_BaseMuzzleSmoke3rd'),ShellEjectBones=("Shell_port"),ShellEjectClasses=(Class'KFMod.KFShellSpewer'))
     ...
     //Mesh=SkeletalMesh'UM_WM1911Pistol_A.colt_3rd'
	 MeshRef="UM_WM1911Pistol_A.colt_3rd"
}
