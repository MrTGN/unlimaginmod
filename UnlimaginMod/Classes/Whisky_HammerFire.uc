...
//================================================================================
// Axe Fire
class Whisky_HammerFire extends KFMeleeFire;
...
defaultproperties
{
     HeadShotDamageClass=Class'UnlimaginMod.Whisky_DamTypeHammerHeadShot'
     ...
     FireAnims(2)="fire3"
     FireAnims(3)="Fire4"
	 MomentumTransfer=240000.000000
     ...
     AppliedMomentumCurve=(Points=((OutVal=10000.000000),(InVal=350.000000,OutVal=160000.000000),(InVal=600.000000,OutVal=240000.000000)))
     MeleeDamage=160
     ProxySize=0.150000
     weaponRange=94.000000
     DamagedelayMin=0.600000
     DamagedelayMax=0.600000
     hitDamageClass=Class'UnlimaginMod.Whisky_DamTypeHammer'
