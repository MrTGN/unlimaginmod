class ZedekPD_MR96RevolverAttachment extends UM_BaseRevolverAttachment;


defaultproperties
{
	 FireModeEffects[0]=(FlashClasses=(Class'ROEffects.MuzzleFlash3rdMP'),SmokeClasses=(Class'UnlimaginMod.UM_BaseMuzzleSmoke3rd'))
